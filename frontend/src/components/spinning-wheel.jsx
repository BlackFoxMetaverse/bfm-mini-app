...
const SpinningWheel = ({ onSpinComplete, canSpin = true, className }) => {
  ...
  return (
    <div className="relative">
      <div
        className={`mx-auto flex h-full w-full max-w-md flex-col items-center justify-between  ${className}`}
      >
        ...
        <div className="relative rounded-full border-[16px] border-slate-700 bg-slate-700 shadow-2xl">
          ...
          <div
            className="absolute -bottom-20 -left-10 z-10 flex h-[70%] w-[125%] items-end justify-center rounded-3xl bg-gradient-to-b from-slate-800 to-slate-900 pb-4 shadow-2xl"
            style={{
              boxShadow:
