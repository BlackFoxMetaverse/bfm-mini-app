...
const SuccessPopup = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-center p-4">
      ...
      >
        <div className="relative overflow-hidden rounded-xl border border-green-300/30 bg-gradient-to-br from-green-400/50 to-emerald-500/50 shadow-2xl backdrop-blur-xl">
          {/* Animated background pattern with more vibrancy */}
          <div className="absolute inset-0 bg-gradient-to-br from-green-300/20 to-emerald-400/20">
          ...
          <div className="relative p-4">
            ...
            <div className="mb-3 flex items-center justify-between">
              <div className="flex items-center gap-2">
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-green-300/30 backdrop-blur-sm">
          ...
          <div className="h-0.5 bg-gradient-to-r from-green-300/60 via-emerald-400/60 to-green-300/60" />
        </div>
      </div>
    </div>
  );
